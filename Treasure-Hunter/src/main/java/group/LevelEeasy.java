...
public class LevelEeasy {
	...
	public static void main(String[] args) {
		...
		}else if(yTreasurePosition < yPlayerPosition) {
			System.out.println("You move away from the treasure ");
		}else if (yTreasurePosition == yPlayerPosition && xTreasurePosition != xPlayerPosition )
			System.out.println("You're close, now only left or right");
		attemptsNumber += 1;
		break;
		...
		if(xTreasurePosition < xPlayerPosition) {
			System.out.println("You are closer to the treasure ");
		}else if(xTreasurePosition > xPlayerPosition) {
			System.out.println("You move away from the treasure ");
		}else if (xTreasurePosition == xPlayerPosition && yTreasurePosition != yPlayerPosition )
			System.out.println("You're close,now just up or down");
		attemptsNumber += 1;
		break;
